...
VALUES 
<<<<<<< HEAD
    ('Kyle McParland', 'k@k.com', 1000, 1000, 0, 0, 'blue', 0),
    ('Ben Hallam', 'b@b.com', 300, 300, 0, 0, 'red', 0),
=======
    ('Kyle McParland', 'k@k.com', 0, 0, 0, 0, 'blue', 0),
    ('Ben Hallam', 'b@b.com', 0, 0, 0, 0, 'red', 0),
>>>>>>> 36c80d0521e016e92daa0eccf91b979b370bacaa
...
VALUES
    ...
    'Calm the storm', 'Draw your weapon', 75, 50, 'The figure dissolves into thin air!', 'The mist blinds you and you are foreced to flee.'),
    ...
    'Prepare yourself for the fiery trials within the Ashen Peaks. Perform the sacred dance of the Emberflame, completing 10,000 steps through volcanic terrain to reach the Heart of the Firestorm and become the Emberflame Dancer!',
    2000, 'After your final step, the fire surrounding you subsides, revealing a glowing emberstone at the peak. Before you can approach, a fiery guardian appears, its molten eyes staring you down.',
    'Submit to the guardian', 'Defeat the guardian', 80, 60, 'The guardian grants you the Emberstone and 20 Gold, leaving you with newfound wisdom.', 'The battle is hard-fought, but you succumb to the flames, your dance unfinished.'),
    ('The Quest for the Frostbound Crown', 
    'Brave Frostwanderer, traverse the frozen wastes of the Glacial Expanse. Complete 3,000 steps through icy tundras and blizzards to reach the Throne of the Frost King and claim the legendary Frostbound Crown!',
    1500, 'As you arrive at the throne, a shimmering figure appears. The Frost King himself, guarding the crown, rises from the ice with a cold glare.',
    'Speak with the Frost King', 'Challenge the Frost King to a duel', 70, 50, 'The Frost King, impressed with your wit, offers you the crown and a blessing of the frozen north!', 'Your duel ends in defeat, but the king allows you to return with your life, though the crown remains untouched.'),
     ('The March of the Ironfoot', 
    'Warrior of the Forge, march across the Metal Plains, where the ground hums with the power of ancient forges. Walk 12,000 steps to reach the Iron Citadel and claim the title of Ironfoot Conqueror!',
    1200, 'Upon reaching the Iron Citadel, a massive gate opens, revealing a blacksmith guardian who questions your resolve. Before you can respond, an army of iron golems approaches!',
    'Stand your ground', 'Bargain with the golems', 65, 70, 'You stand strong, and the golems, impressed by your courage, allow you entry and grant you 25 Gold!', 'The golems overwhelm you, but you escape with your life, only to find yourself further from your goal than before.');
